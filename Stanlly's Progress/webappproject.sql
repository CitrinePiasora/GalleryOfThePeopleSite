...
INSERT INTO `paintings` (`ID`, `Title`, `Date`, `Resolution`, `Copyright`, `Source`, `UploaderID`) VALUES
(1, 'Casual', '2021-03-28', NULL, 'Jane Piasora', 'Image/1.png', 1),
(2, 'Level-headed Merc', '2021-03-28', NULL, 'Jane Piasora', 'Image/2.jpg', 1),
(3, 'Foxy Mage', '2021-03-28', NULL, 'Jane Piasora', 'Image/3.jpg', 1),
(4, 'White Witch', '2021-03-28', NULL, 'Jane Piasora', 'Image/4.jpg', 1),
(5, 'Guard of Seiryu', '2021-03-28', NULL, 'Jane Piasora', 'Image/5.jpg', 1),
(6, 'Urban Chic', '2021-03-28', NULL, 'Jane Piasora', 'Image/6.jpg', 1),
(7, 'Elegant Dancer', '2021-03-28', NULL, 'Jane Piasora', 'Image/7.png', 1),
(8, 'Dark Defender', '2021-03-28', NULL, 'Jane Piasora', 'Image/8.jpg', 1),
(9, 'Classy Bookworm', '2021-03-28', NULL, 'Jane Piasora', 'Image/9.jpg', 1);
...
--
ALTER TABLE `photography`
  ADD CONSTRAINT `UploaderPhoto` FOREIGN KEY (`UploaderID`) REFERENCES `users` (`ID`) ON DELETE SET NULL ON UPDATE CASCADE;
