...
<body>
    <nav class="navbar navbar-expand-lg navbar-light" style="background-color: skyblue; z-index: 999;">
    ...
    <div class="responsive">
        <div class= "gallery">
            <a href="redirectGallery.php?category=paintings" target="_self"><img src="CoverImages/painting.jpg" width="250" height="200"></a>
            <div class= "desc"> Paintings </div>
        </div>
    </div>
    <div class="responsive">
        <div class= "gallery">
            <a href="redirectGallery.php?category=sculptures" target="_self"><img src="CoverImages/sculpture.jpg" width="250" height="200"></a>
            <div class= "desc"> Sculptures </div>
        </div>
    </div>
    <div class="responsive">
        <div class= "gallery">
            <a href="redirectGallery.php?category=photography" target="_self"><img src="CoverImages/photography.jpg" width="250" height="200"></a>
            <div class= "desc"> Photography </div>
        </div>
    </div>
    <div class="responsive">
        <div class= "gallery">
            <a href="redirectGallery.php?category=digital" target="_self"><img src="CoverImages/digital.jpg" width="250" height="200"></a>
