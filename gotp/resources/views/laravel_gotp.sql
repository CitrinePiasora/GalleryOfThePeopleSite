...
--
-- Host: 127.0.0.1
-- Generation Time: May 03, 2021 at 10:35 AM
...
(6, '2021_05_02_105649_create_photographies_table', 1),
(7, '2021_05_02_105700_create_sculptures_table', 1);
...
INSERT INTO `photographies` (`id`, `title`, `copyright`, `source`, `path`, `uploader_id`, `description`, `created_at`, `updated_at`) VALUES
(1, 'casual', 'Jane', 'PC', '{{url(\'public/Image/1.png\')}}', 1, 'No, just no', '2021-05-03 08:28:13', '2021-05-03 08:28:13');
...
(1, 'Jane', 'jane@gmail.com', '2021-05-03 08:27:43', '12345678', NULL, '2021-05-03 08:27:43', '2021-05-03 08:27:43');
...
ALTER TABLE `photographies`
  ADD PRIMARY KEY (`id`),
  ADD KEY `photographies_uploader_id_foreign` (`uploader_id`);
...
--
ALTER TABLE `photographies`
  ADD CONSTRAINT `photographies_uploader_id_foreign` FOREIGN KEY (`uploader_id`) REFERENCES `users` (`id`) ON DELETE SET NULL ON UPDATE CASCADE;
